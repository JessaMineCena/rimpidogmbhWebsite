...
var substanceMainHeader = document.getElementById('substance-main-header');
var substanceSubHeader1 = document.getElementById('substance-sub-header1');
var substanceDesc1 = document.getElementById('substance-desc1');
...
if(getLanguage=="en")
{
	window.location="substancevolumetracking.php";
}
...
substanceMainHeader.innerHTML = "";
substanceSubHeader1.innerHTML = "";
substanceDesc1.innerHTML = "";
}
